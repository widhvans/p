...
async def claim_verification_for_file(file_unique_id: str, requester_id: int, owner_id: int) -> bool:
    unclaimed_file_query = {'file_unique_id': file_unique_id, 'owner_id': owner_id, 'verification_claimed': {'$ne': True}}
...
async def get_file_by_unique_id(file_unique_id: str, owner_id: int = None):
    query = {'file_unique_id': file_unique_id}
    if owner_id:
        query['owner_id'] = owner_id
    return await files.find_one(query)
